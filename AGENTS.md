...
Before merging `upstream/main` or placing a downstream feature beside upstream,
use [.agents/skills/multica-upstream-sync/SKILL.md](.agents/skills/multica-upstream-sync/SKILL.md).
It reads [docs/downstream/upstream-sync.md](docs/downstream/upstream-sync.md) for
path ownership, published migration identities, and prior conflict decisions.
