...
SELECT i.id, i.workspace_id, i.recipient_type, i.recipient_id, i.type, i.severity, i.issue_id, i.title, i.body, i.read, i.archived, i.created_at, i.actor_type, i.actor_id, i.details, i.room_id, i.room_cycle_id, i.room_review_identity, i.room_attention_key, selected.issue_status, selected.issue_priority,
...
func (q *Queries) ListArchivedInboxPage(ctx context.Context, arg ListArchivedInboxPageParams) ([]ListArchivedInboxPageRow, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&i.InboxItem.Details,
			&i.InboxItem.RoomID,
			&i.InboxItem.RoomCycleID,
			&i.InboxItem.RoomReviewIdentity,
			&i.InboxItem.RoomAttentionKey,
			&i.IssueStatus,
			&i.IssuePriority,
			&i.CommentID,
		); err != nil {
