...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"lm_wiki_citation":                workspaceDelete,
	"lm_wiki_review":                  workspaceDelete,
	"lm_wiki_revision":                workspaceDelete,
	"lm_wiki_source_policy":           workspaceDelete,
	"lm_wiki_source_wiki_page":        workspaceDelete,
	...
	"room":                            workspaceDelete,
	"room_artifact":                   workspaceDelete,
	"room_memory_revision":            workspaceDelete,
	"room_recommendation_review":      workspaceDelete,
	"room_cycle":                      workspaceDelete,
	"room_entry":                      workspaceDelete,
	"room_participant":                workspaceDelete,
	"room_turn":                       workspaceDelete,
	...
	"twin_binding":                    workspaceDelete,
	"twin_deposition":                 workspaceDelete,
	"twin_run_feedback":               workspaceDelete,
	"twin_task_attribution":           workspaceDelete,
	"twin_version":                    workspaceDelete,
	...
	"wiki_page_edit_proposal":         workspaceDelete,
	"wiki_page_revision":              workspaceDelete,
