...
var legacyDuplicateMigrationStems = map[string][]string{
	"480": {"480_instance_telemetry_state_singleton_index", "480_twin_activation_preview_checkpoint"},
	"481": {"481_instance_telemetry_state_primary_key", "481_twin_activation_preview_checkpoint_index"},
	"482": {"482_agent_task_queue_telemetry_started_index", "482_skill_evolution_tables"},
	"483": {"483_agent_task_queue_manual_rerun_index", "483_issue_triage_state"},
	"484": {"484_issue_triage_state_index", "484_skill_evolution_loop_id_index"},
	"485": {"485_maintenance_job", "485_skill_evolution_revision_id_index"},
	"486": {"486_maintenance_job_id_index", "486_skill_evolution_revision_file_id_index"},
	"487": {"487_maintenance_job_idempotency_index", "487_skill_evolution_proposal_id_index"},
	"488": {"488_maintenance_job_active_index", "488_skill_evolution_evidence_id_index"},
	"489": {"489_issue_triage_state_validate", "489_skill_evolution_evaluation_id_index"},
	"490": {"490_drop_triage_status_key_reservation", "490_skill_evolution_review_id_index"},
	"491": {"491_issue_status_category_backfill", "491_skill_evolution_release_id_index"},
	"492": {"492_issue_status_category_contract", "492_skill_evolution_task_attribution_id_index"},
	"493": {"493_issue_status_category_validate", "493_task_run_review_id_index"},
	"494": {"494_issue_status_category_read_contract", "494_skill_evolution_loop_skill_index"},
	"495": {"495_issue_to_label_label_id_index", "495_skill_evolution_revision_hash_index"},
	"496": {"496_chat_session_agent_id_index", "496_skill_evolution_revision_file_path_index"},
