...
export function LandingHero() {
  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-[var(--landing-night)] text-white">
      <LandingBackdrop />
      ...
      <main className="relative z-10">
        ...
        >
          <div className="mx-auto max-w-[1120px] text-center">
            <h1 className="landing-serif text-[3.65rem] leading-[0.93] tracking-normal text-white drop-shadow-[0_10px_34px_rgba(0,0,0,0.32)] sm:text-[4.85rem] lg:text-[6.4rem]">
              {t.hero.headlineLine1}
              <br />
              {t.hero.headlineLine2}
            </h1>

            <p className="mx-auto mt-7 max-w-[820px] text-body-lg leading-7 text-white sm:text-title">
              {t.hero.subheading}
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link
                href="/contact-sales"
                className="group inline-flex items-center justify-center gap-1.5 rounded-[12px] px-3 py-3 text-body font-semibold text-white transition-colors hover:bg-white/8"
              >
                {t.hero.talkToSales}
                <ArrowRight
