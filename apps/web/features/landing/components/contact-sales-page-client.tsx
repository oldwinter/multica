...
export function ContactSalesPageClient() {
  ...
  return (
    <>
      ...
      <main className="bg-page-canvas text-foreground">
        <div
          ref={successAnchorRef}
          className="mx-auto max-w-[760px] px-4 py-12 sm:px-6 sm:py-16 lg:py-20"
        >
          <div className="mb-8 text-center">
            <p className="text-caption font-semibold uppercase tracking-normal text-muted-foreground">
              {c.eyebrow}
            </p>
            <h1 className="mt-2 landing-serif text-[2.4rem] leading-[1.1] tracking-normal sm:text-[2.8rem]">
              {c.title}
            </h1>
...
function SuccessCard({
  ...
  return (
    <div className="rounded-[16px] border border-border bg-surface p-8 shadow-[0_1px_2px_rgba(10,13,18,0.04)] sm:p-10">
      ...
      <p className="mt-3 text-body-lg leading-[1.7] text-muted-foreground">
        {message}
      </p>
      <div className="mt-6">
        <Link
...
function Field({
  ...
  return (
    <div className="space-y-1.5">
      <label
        htmlFor={htmlFor}
        className="block text-label font-medium text-muted-foreground"
      >
        {label}
      ...
      {hint ? (
        <p
          ...
          className={
            tone === "warning"
              ? "text-caption leading-[1.55] text-destructive"
              : "text-caption leading-[1.55] text-muted-foreground"
          }
        >
          {hint}
        </p>
...
function ConsentBlock({
  ...
  return (
    <div className="space-y-3 text-label leading-[1.65] text-muted-foreground">
      <p className="font-semibold text-foreground">
        {dict.consent.intro}
      </p>
      <ConsentCheckbox
      ...
      <p>
        ...
        <Link
          ...
          className="text-foreground underline decoration-border underline-offset-2 hover:decoration-border"
        >
