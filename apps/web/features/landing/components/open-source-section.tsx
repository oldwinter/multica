...
export function OpenSourceSection() {
  ...
  return (
    <section id="open-source" className="bg-surface text-foreground">
      <div className="mx-auto max-w-[1320px] px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="flex flex-col gap-16 lg:flex-row lg:items-start lg:gap-24">
          ...
          <div className="lg:w-[480px] lg:shrink-0">
            ...
            <p className="mt-6 max-w-[420px] text-body-lg leading-7 text-muted-foreground sm:text-title-sm">
            ...
            <div className="grid gap-px overflow-hidden rounded-2xl border border-border bg-muted sm:grid-cols-2">
              {t.openSource.highlights.map((item) => (
                <div key={item.title} className="bg-surface p-8 lg:p-10">
                  <h3 className="text-title font-semibold leading-snug text-foreground sm:text-title">
                    {item.title}
                  </h3>
                  <p className="mt-3 text-body leading-[1.7] text-muted-foreground sm:text-body-lg">
                    {item.description}
                  </p>
                </div>
              ))}
