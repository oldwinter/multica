        ...
        <div className="flex flex-col gap-12 border-b border-white/10 py-16 sm:py-20 lg:flex-row lg:gap-20">
          ...
          <div className="lg:w-[340px] lg:shrink-0">
            ...
            <div className="mt-6">
              <Link
                href={ctaHref}
                className="inline-flex items-center justify-center rounded-(--landing-radius-button) bg-white px-5 py-2.5 text-label font-semibold text-foreground transition-colors hover:bg-white/88"
              >
